...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_options:
        ...
        county_results_file = (f"{county_name}: {county_vote_percentage:.1f}% ({county_vote_tally:,})\n")
        county_results_terminal = (f"{county_name}: {county_vote_percentage:.1f}% ({county_vote_tally:,})")
        ...
        if (county_vote_tally > highest_county_count):
            highest_county = county_name
            highest_county_count = county_vote_tally
